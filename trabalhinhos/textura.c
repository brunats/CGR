...
int LoadGLTextures( )
{
	...
	if (( TextureImage[1] = SDL_LoadBMP( "data/skybox_f.bmp" ) )) {
	...
	if (( TextureImage[2] = SDL_LoadBMP( "data/skybox_r.bmp" ) )) {
	...
	if (( TextureImage[3] = SDL_LoadBMP( "data/skybox_b.bmp" ) )) {
	...
	if (( TextureImage[4] = SDL_LoadBMP( "data/skybox_l.bmp" ) )) {
	...
	if (( TextureImage[5] = SDL_LoadBMP( "data/skybox_d.bmp" ) )) {
	...
	if (( TextureImage[6] = SDL_LoadBMP( "data/skybox_u.bmp" ) )) {
    	glBindTexture( GL_TEXTURE_2D, texture[6] );
    	glTexImage2D( GL_TEXTURE_2D, 0, 3, TextureImage[6]->w, TextureImage[6]->h, 0, GL_BGR, 
                  GL_UNSIGNED_BYTE, TextureImage[6]->pixels );
	    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER,
			     GL_NEAREST );
	    glTexParameteri( GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER,
			     GL_NEAREST );
